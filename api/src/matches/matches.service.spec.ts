...
describe('MatchesService', () => {
    ...
    describe('create', () => {
        it('should create a new match', async () => {
            const createMatchDto: CreateMatchDto = {
                firstTeam: { id: 'team1', name: 'Team 1' },
                secondTeam: { id: 'team2', name: 'Team 2' },
                dateTime: new Date(),
            };
        ...
        it('should throw NotFoundException if one or both teams are not found', async () => {
            const createMatchDto = {
                firstTeam: { id: 'team1', name: 'Team 1', score: 2 },
                secondTeam: { id: 'team2', name: 'Team 2', score: 3 },
                dateTime: new Date(),
            };
            ...
            const matches: Match[] = [
                {
                    ...
                    dateTime: new Date(),
                    score: '2-1',
                    firstTeam: { id: '1', name: 'team1' },
                    secondTeam: { id: '2', name: 'team2' },
                },
                {
                    id: 'match2',
                    dateTime: new Date(),
    ...
    describe('findOne', () => {
        it('should return a match if it exists', async () => {
            ...
            jest.spyOn(matchRepository, 'findOneBy').mockResolvedValueOnce(
                match,
            );
    ...
    describe('update', () => {
        it('should update an existing match', async () => {
            const match = {
                id: 'match1',
                firstTeam: { id: 'team1' } as Team,
                secondTeam: { id: 'team2' } as Team,
            } as Match;
            ...
            jest.spyOn(matchRepository, 'create');
            jest.spyOn(matchRepository, 'save').mockResolvedValueOnce({
                ...match,
                score: '2-3',
            });
            ...
            expect(matchRepository.save).toHaveBeenCalledWith(
                expect.objectContaining({ score: '2-3' }),
            );
        });
        ...
        it('should throw NotFoundException if one or both teams are not found', async () => {
            ...
            await expect(
                service.update('match1', updateMatchDto),
